...
class JobsQuery : Query<JobsQuery.Data, JobsQuery.Data, Operation.Variables> {
  ...
  data class Data(
    ...
    companion object {
      ...
      operator fun invoke(reader: ResponseReader): Data = reader.run {
        val jobs = readList<Job>(RESPONSE_FIELDS[0]) { reader ->
  ...
  companion object {
    ...
    val OPERATION_NAME: OperationName = object : OperationName {
      override fun name(): String = "JobsQuery"
    }
  }
}
